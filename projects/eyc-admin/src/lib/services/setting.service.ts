...
export class SettingService {
  ...
  get task_assignment(): any {
    const task_assignment = {
      tasks_assignment_list: this.rrproduction ? this.API_ENDPOINT + 'gatewayService/api/v2/regreporting/static-data/forms/taskassignment-mapping' : this.API_ENDPOINT + 'assets/mock/taskAssignment.json',
    }
