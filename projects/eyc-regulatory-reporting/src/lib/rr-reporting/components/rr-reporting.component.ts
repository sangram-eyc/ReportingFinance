  ...
  exportData(type) {
    ...
    if(type == 'entities') {
      ...
      if(this.permissions.validatePermission('Reporting', 'View Comments')) { 
        ...
        this.exportHeaders = 'exceptionReportType:Exception Report Type,exceptionReportName:Exception Report Name,unResolvedException:Unresolved,resolvedException:Resolved,comments:Comments,updateBy:Last Updated By';
      } else {
        ...
        this.exportHeaders = 'exceptionReportType:Exception Report Type,exceptionReportName:Exception Report Name,unResolvedException:Unresolved,resolvedException:Resolved,updateBy:Last Updated By';
      }
