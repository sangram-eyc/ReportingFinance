...
@Component({
  ...
  templateUrl: './intake-exceptions-reports.component.html',
  styleUrls: ['./intake-exceptions-reports.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class IntakeExceptionsReportsComponent implements OnInit, AfterViewInit {
