...
export class EycRrSettingsService {
  ...
  get regReportingFiling(): any {
    const regulatory_Reporting = {
      ...
      filing_details: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/filings.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/filings.json',
      ...
      rr_exception_reports: this.rrproduction ? this.API_ENDPOINT + 'gatewayService/api/v2/regreporting/entity?stage=Reporting' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/exceptionReports.json',
