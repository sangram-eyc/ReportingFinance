...
export class EycRrSettingsService {
  ...
  get regReportingFiling(): any {
    const regulatory_Reporting = {
      ...
      rr_filing_entities: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/filingEntities.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/filingEntities.json',
      ...
      client_review_filing_entities: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/filingEntities.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/filingEntities.json',
