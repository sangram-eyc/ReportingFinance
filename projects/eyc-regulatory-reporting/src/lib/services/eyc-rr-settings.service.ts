...
export class EycRrSettingsService {
  ...
  get regReportingFiling(): any {
    const regulatory_Reporting = {
      ...
      di_exception_reports: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/FDI_exception_details.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/FDI_exception_details.json',
      ...
      files_list: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/FDI_exception_summary.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/FDI_exception_summary.json',
      datasets_list: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/FDI_exception_details.json' : this.API_ENDPOINT +  'assets/eyc-regulatory-reporting/mock/FDI_exception_details.json',
      ...
      view_exception_reports: this.rrproduction ? this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/viewExceptionReports.json' : this.API_ENDPOINT + 'assets/eyc-regulatory-reporting/mock/viewExceptionReports.json',
    }
