...
@Component({
  selector: 'lib-individual-exceptions-resolve',
  templateUrl: './individual-exceptions-resolve.component.html',
  styleUrls: ['./individual-exceptions-resolve.component.scss']
})
export class IndividualExceptionsResolveComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<IndividualExceptionsResolveComponent>,
  ...
  onClickYes() {
    if (this.modalDetails.type === "ConfirmationTextUpload") {
      const commentObj = {
        ...
        "entityIds": [
          ...this.modalDetails.auditResultObjectId,
        ],
