...
@Component({
  selector: 'lib-eyc-powerbi-embed',
  templateUrl: './eyc-powerbi-embed.component.html',
  styleUrls: ['./eyc-powerbi-embed.component.scss']
})
export class EycPowerbiEmbedComponent implements OnInit {
