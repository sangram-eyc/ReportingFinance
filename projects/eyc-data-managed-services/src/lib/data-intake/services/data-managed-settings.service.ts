...
export class DataManagedSettingsService {
  ...
  get dataManagedServices(): any {
    const data_Managed_Services = {
      ...
      file_data_provider_daily: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/data-providers-daily.json',
      file_data_provider_monthly: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/data-providers-monthly.json',
      file_data_domain_daily: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/data-domains-daily.json',
      file_data_domain_monthly: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/data-domains-monthly.json',
      file_general_ledger_daily: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/general-ledger-data.json',
      file_general_ledger: this.production ? this.API_ENDPOINT + 'gatewayService/api/v2/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/general-ledger-data.json',
