...
export class DataManagedSettingsService {
  ...
  get dataManagedServices(): any {
    const data_Managed_Services = {
      ...
      file_review_table_data: this.production ? this.API_ENDPOINT + 'dmsdataintakeservice/api/v2/dms/' : this.API_ENDPOINT + 'assets/eyc-data-managed-services/mock/review-file-data.json'
    }
