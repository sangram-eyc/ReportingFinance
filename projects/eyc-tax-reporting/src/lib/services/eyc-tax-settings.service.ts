...
export class EycTaxSettingsService {
  ...
  get taxReporting(): any {
    const tax_Reporting = {
      ...
      sse_client_url : this.production ? 'https://eycomply-qa.sbp.eyclienthub.com/qa37/notifierAgentService/sse-notifier-agent-communication-async/' : 'https://eycomply-qa.sbp.eyclienthub.com/qa37/notifierAgentService/sse-notifier-agent-communication-async/',
