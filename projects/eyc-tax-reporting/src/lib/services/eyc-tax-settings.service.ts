...
export class EycTaxSettingsService {
  ...
  get taxReporting(): any {
    const tax_Reporting = {
      ...
      bulk_download_service1 : this.production ? this.API_ENDPOINT + 'assets/eyc-tax-reporting/mock/bulk-download-response.json' : this.API_ENDPOINT + 'assets/eyc-tax-reporting/mock/bulk-download-response.json'
    }
