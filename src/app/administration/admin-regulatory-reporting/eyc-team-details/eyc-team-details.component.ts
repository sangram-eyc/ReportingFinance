...
export class EycTeamDetailsComponent implements OnInit {
  ...
  exportTeamsDetailsData() {
    ...
    this.exportUrl = this.apiHelpers.teams.teams_Details + this.curentTeamId + "&module="+ this.module+"&teamName="+ this.teamInfo.teamName+"&export=" + true +"&headers=" + this.exportHeaders + "&reportType=csv";
