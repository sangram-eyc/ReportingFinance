...
export const userAdminstration = {
    regulatory_Reporting: {
        ...
        view_User_Details: environment.production ?  environment.apiEndpoint + '/api/v2/authorization/user' : environment.apiEndpoint + 'assets/mock/users.json',
    }
};

export const authorization = {
   
        auth_Details: environment.AUTH_PROD ? environment.SERVICE_URL + 'authenticationService/api/v2/authentication/getDetails' : environment.apiEndpoint + 'assets/mock/auth.json',
        
};

export const token_interceptor = {
   
    auth_Header: environment.AUTH_PROD ? '/api/v2/authentication/getDetails' : 'assets/mock/auth.json',
