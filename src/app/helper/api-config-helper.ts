...
export const authorization = {
     auth_Details: environment.production ? environment.apiEndpoint + 'authenticationService/api/v2/authentication/getDetails' : environment.apiEndpoint + 'assets/mock/auth.json',
};
